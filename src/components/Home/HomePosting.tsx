      ...
      <div className={componentStyles.homeContainer}>
        ...
        >
          {imageList.map((item, index) => (
            <div
              key={index}
              className={componentStyles.galleryImageWrapper}
              onClick={() => onImageClick(item)}
            >
              <img
                src={item.src}
                alt={item.title}
                className={componentStyles.galleryImage}
              />
              <div className={componentStyles.imageInfo}>
                ...
                <div className={componentStyles.likes}>
                  <FontAwesomeIcon icon={faHeart} />
                  {item.likes}
                </div>
                <div className={componentStyles.location}>
                  <BsGeoAltFill />
                  {item.location}
                </div>
              </div>
        ...
        <HomeModal open={isModalOpen} handleClose={closeModal}>
          <div className={componentStyles.modalInnerContent}>
            <img
              ...
              className={componentStyles.modalImage}
            />
            <div className={componentStyles.modalTextContent}>
              ...
              <div>
                <BsGeoAltFill /> {selectedImage.location}
              </div>
            </div>
          </div>
        </HomeModal>
